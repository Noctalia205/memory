...
<head>
  <meta charset="utf-8">
  <title>Page de jeu Nourriture</title>
  ...
  <nav class="main-nav">
            ...
            <ul>
                ...
                <li class="navpoint"><a href="page_jeu_dbz.php">Jeu</a></li>
                <li class="navpoint"><a href="page_de_score.php">Score</a></li>
...
<footer>
    <div><h2 class ="titre1">Information</h2>
      ...
      <ul class="two">
      <li><a href="page_jeu_dbz.php" class="listefooter">Jouer !</a></li><br/>
          <li><a href="../page_de_score.php" class="listefooter">Les scores</a></li><br/>
