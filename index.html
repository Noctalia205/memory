...
<body>
    ...
    <div class="img-head">
        ...
        <div class="button"><a href="page_jeu_meme.html">Jouez !</a></button>
    </div>
    </div>
    </header>
        ...
        <main>
            <div class="flex-all">
                ...
                <div class="img-start"><img src="img/cerveau.jpg" alt="cerveau"></div>
                <div class=""><img src="img/motivation.jpg" alt="motivation"></div>
                <div class="img-end"><img src="img/ordinateur.jpg" alt="ordinateur"></div>
                </div>
    ...
    <div id="main-block">
        <div class="block-img">
            <img src="img/anime.jpg" alt="Anime girl">
        </div>
        <div class="all-block">
            <div class="block1">
     ...
     <section class="text-equip"><p>L'équipe qui slay</p></section>
     <div class="sous-title">La slaytitude représentée par 3 queenies </div>
     <div class="line-gold"><img src="img/line-gold.png" alt="line gold"></div>

     <div class="flex-card">
        <div class="person-container">
            <div class="person-card">
                <div class="person-img"><img class="avatar" src="img/Fiafei.jpg" alt="Jiafey la queen"></div>
                <p>JIAFEI</p>
                <div class="sous-title">Chang-chang developpeuse</div>
                <div class="social-media"><img class="social-img" src="img/social-media.jpg" alt="réseaux sociaux"></div>
            </div>
        </div>
        <div class="person-container">
            <div class="person-card">
                <div class="person-img"><img class="avatar-2" src="img/jiafei_avocat.jpg" alt="Jiafey l'avocat"></div>
                <p>JIAFEI AVOCAT</p>
        ...
        <div class="person-container">
            <div class="person-card">
                <div class="person-img"><img class="avatar-3" src="img/Kris.jpg" alt="Kris la reine"></div>
                <p>KRIS DARLING</p>
