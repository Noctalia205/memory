    ...
    <div class="icon-score">
        <div class="person-container">
            <div class="score-person-card">
                <div class="person-img"><img class="score-avatar" src="img/Jiafei-1.jpg" alt="Jiafey UwU"></div>
                <p>TON PROFIL</p>
            </div>
        </div>
    </div>
    <div class="classement-container">
        <div class="classement-score">
            <div class="num-classement">
                <p>Classement : <span>1</span></p>
            </div>
        </div>
    </div>
