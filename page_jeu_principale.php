...
<button class="btt_start" id="strt">start</button>
</div>
        ...
        <input class="button_commencer_jeu" type="button" id="button_commencer_jeu" value="Lancer le jeu" onclick="checkSelectedAndChrono()">
